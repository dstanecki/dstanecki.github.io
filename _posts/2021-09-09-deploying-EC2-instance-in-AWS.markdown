...
![WinSCP](/assets/winSCP.png){:class="img-responsive"}
...
![TestPage](/assets/testPage.png){:class="img-responsive"}

I also set up the sample page provided by AWS. Here's what that looks like:
![SamplePage](/assets/SamplePage.png){:class="img-responsive"}
![SamplePage2](/assets/SamplePage2.png){:class="img-responsive"}
